...
imageIndexes1.forEach((i) => {
  ...
  image1.addEventListener("click", () => {
    ...
    selectedImage.alt = `Lost Moment number ${i} retrived on 11-5-2020`;
  });
...
const imageIndexes3 = [
  ...
  99, 100, 101, 102, 103, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115,
  ...
  254, 255, 256, 257, 259, 260, 261, 262, 263, 268, 269, 270, 273, 274, 275,
  276, 277, 278, 279,
];
